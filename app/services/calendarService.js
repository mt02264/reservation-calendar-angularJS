calendarApp.service("calendarService", ["$http", function($http){
    ...
    */
    ...
    /*
        whenever http request gets an error,
        this function pops an alert displaying
        the error received from the server
    */
        switch(reason.status){
            case -1:
                alert("Wrong URL used, please check it again!!!");
                break;
            default:
    ...
    */
        self.calendarObject.atInitialLoad = true;
    ...
    */
    ...
    /*
        atInitialLoad disables the buttons until 
        tenant data has been loaded
    */
    this.calendarObject = {
        atInitialLoad : true,
        weekdays,
